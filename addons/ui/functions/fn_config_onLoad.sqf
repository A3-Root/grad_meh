...
private _options = uiNamespace getVariable ["grad_meh_options",  [true, true, true, true, true, true, true, true]];

_options params ["_exportSat", "_exportTopo", "_exportBakedTopo", "_exportHouses", "_exportPreviewImg", "_exportMeta", "_exportDem", ["_exportArmaTopo", true]];
...
(_display displayCtrl IDC_CONFIG_CHECK_ARMA_TOPO) cbSetChecked _exportArmaTopo;
